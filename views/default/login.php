...
?>
<div class="topo-login titulo">
    <?= Html::img('@web/assets-churches/img/logo.jpg', ['class' => 'img-login', 'alt' => 'Logo Churches']); ?>
</div>
...
<?= $form->field($model, 'username')->textInput(['class' => 'form-control', 'placeholder' => 'E-mail'])->label(false) ?>
...
<div class="bt-center-login">
    <?= Html::submitButton(Yii::t('user', 'Login'), ['class' => 'btn btn-contato']) ?>
